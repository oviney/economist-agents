...
## Architecture & Design
- [ARCHITECTURE_PATTERNS.md](ARCHITECTURE_PATTERNS.md) - Learned architectural patterns
...
- [JEKYLL_EXPERTISE.md](JEKYLL_EXPERTISE.md) - Jekyll integration knowledge

## Operations
- [GITHUB_ACTIONS_SETUP.md](GITHUB_ACTIONS_SETUP.md) - CI/CD configuration

## Active Issues & Backlog
- [Open Issues](https://github.com/oviney/economist-agents/issues?q=is%3Aissue+is%3Aopen)
- [P1 Priority](https://github.com/oviney/economist-agents/issues?q=is%3Aissue+is%3Aopen+label%3AP1)
- [P2 Priority](https://github.com/oviney/economist-agents/issues?q=is%3Aissue+is%3Aopen+label%3AP2)
