...
class ArchitectureReviewer:
    ...
    def _analyze_agent_architecture(self):
        ...
        for py_file in scripts_dir.glob("*.py"):
            with open(py_file) as f:
                ...
                prompts = re.findall(r'^([A-Z_]+_PROMPT)\s*=\s*"""', content, re.MULTILINE)
                if prompts:
                ...
                if 'BANNED' in content or 'FORBIDDEN' in content:
                    ...
                    self.skills_manager.learn_pattern(
                        ...
                        "explicit_constraint_lists",
                        {
                            ...
                            "examples": ["BANNED OPENINGS", "BANNED PHRASES", "FORBIDDEN CLOSINGS"],
        ...
        if skills_files:
            self.skills_manager.learn_pattern(
                ...
                "continuous_learning_validation",
                {
                    ...
                    "categories": ["content_quality", "seo_validation", "link_validation"],
    ...
    def export_to_markdown(self, output_path: Path = None):
        ...
        doc.append(f"Last updated: {self.skills_manager.skills.get('last_updated', 'Unknown')}")
        doc.append("")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Review architecture and learn patterns')
    parser.add_argument('--full-review', action='store_true', help='Run complete architecture review')
    parser.add_argument('--show-skills', action='store_true', help='Show learned architectural patterns')
    parser.add_argument('--export-docs', action='store_true', help='Export patterns to markdown')
    parser.add_argument('--focus', help='Focus on specific area (agent-patterns, data-flow, etc)')
