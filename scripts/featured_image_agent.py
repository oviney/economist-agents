...
def create_image_prompt(topic: str, article_summary: str, contrarian_angle: str = "") -> str:
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Generate Economist-style featured images')
