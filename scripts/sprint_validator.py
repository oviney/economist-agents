...
class SprintValidator:
    ...
    def get_sprint_stories(self) -> list:
        ...
        for match in matches:
            ...
            for checked, task_text in task_matches:
                tasks.append({"text": task_text, "completed": checked == "x"})
    ...
    def check_before_work(self, work_description: str) -> bool:
        ...
        story_section = self.sprint_content[
            self.sprint_content.find(matching_story["title"]) :
        ]
        ...
        print("=" * 60)
        print("\n📝 Remember to:")
        print("   1. Update task checkboxes in SPRINT.md as you progress")
        print(f"   2. Reference 'Story {matching_story['number']}' in commit messages")
        print("   3. Update sprint status when story is complete\n")
    ...
    def validate_sprint(self) -> bool:
        ...
        completion_rate = (
            sprint["points_done"] / sprint["points_total"]
            if sprint["points_total"] > 0
            else 0
        )
