...
def test_metrics_collection():
    ...
    print(f"  ✓ Recorded successful generation ({chart_record['generation_time_seconds']:.3f}s)")
    ...
    print("\nTest 3: Chart Generation Failure")
    chart_spec2 = {
        "title": "Test Chart: Failed Generation",
        "type": "bar",
        "data": []
    }
    ...
    time.sleep(0.05)
    metrics.record_generation(chart_record2, success=False, error="Invalid data: empty dataset")
    ...
    qa_result_fail = {
        ...
        "gates": {
            ...
            "label_positioning": {"pass": False, "issues": ["Label collision detected"]},
            "style_compliance": {"pass": True, "issues": []},
            "data_export": {"pass": True, "issues": []}
        },
        "critical_issues": [
