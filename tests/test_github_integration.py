...
class GitHubIntegrationTests:
    ...
    def test_sprint_validator_stories(self):
        ...
        assert story1['points'] == 2, f"Story 1 should be 2 points, got {story1['points']}"
    ...
    def test_sprint_sync_imports(self):
        ...
        try:
            ...
            print(f"      ✓ GitHubSprintSync class importable")
            ...
            print(f"      ⚠ PyGithub not installed (optional)")
    ...
    def test_github_actions_structure(self):
        ...
        with open('.github/workflows/sprint-discipline.yml', 'r') as f:
        ...
        print(f"      ✓ Sprint discipline workflow properly structured")
    ...
    def test_pr_template_structure(self):
        ...
        print(f"      ✓ PR template has all required checks")
    ...
    def test_skills_system_integration(self):
        ...
        with open('skills/blog_qa_skills.json', 'r') as f:
            skills = json.load(f)
        
        assert 'sprint_discipline' in skills['skills'], "sprint_discipline category missing"
        ...
        print(f"      ✓ Sprint discipline integrated into skills system")
    ...
    def run_all(self):
        ...
        self.test("Sprint validator detects active sprint", 
                  self.test_sprint_validator_active_sprint)
        
        self.test("Sprint validator parses stories", 
                  self.test_sprint_validator_stories)
        
        self.test("GitHub Actions YAML valid", 
                  self.test_github_actions_yaml_valid)
        
        self.test("Issue templates valid", 
                  self.test_issue_templates_valid)
        
        self.test("Pre-work check script exists", 
                  self.test_pre_work_check_exists)
        
        self.test("Sprint sync script imports", 
                  self.test_sprint_sync_imports)
        
        self.test("Documentation complete", 
                  self.test_documentation_complete)
        
        self.test("GitHub Actions structure", 
                  self.test_github_actions_structure)
        
        self.test("PR template structure", 
                  self.test_pr_template_structure)
        
        self.test("Skills system integration", 
                  self.test_skills_system_integration)
